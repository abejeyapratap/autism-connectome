...
def drawHistogram(data,dataLabels,title,outputPath,xLabel="matching accuracy (%)",yLabel="frequency",colors=['#2096BA','#351C4D', '#AB3E16','#849974', '#F7DFD4','#F5AB99'],noBars=False,normalized=False): #shutter blue, nightfall, rust, fresh, macaron, tropical pink
    import numpy as np
    import scipy.stats as stt
    import matplotlib.pylab as plt
    import matplotlib as mpl
